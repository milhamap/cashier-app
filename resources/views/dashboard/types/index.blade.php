...
@section('content')
    ...
    <div class="table-responsive col-lg-8">
        ...
        @if($categories->count())
            <a href="/dashboard/types/create" class="btn btn-primary mb-3">Create New Type</a>
        @else
        ...
        <table class="table table-striped table-sm">
            ...
            @foreach ($types as $type)
                <tr>
                    ...
                    <td>{{ $type->name }}</td>
                    <td>
                        <a href="/dashboard/types/{{ $type->slug }}/edit" class="badge bg-warning">
    ...
    <div class="mt-3">
        {{ $types->links('dashboard.layouts.pagination') }}
    </div>
@endsection
